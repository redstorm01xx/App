...
export default function NativeFeaturesScreen({ navigation }) {
    return (
        <View style={{ flex: 1 }}>
            ...
            <TouchableOpacity onPress={() => navigation.navigate("Caméra")}> <Text> Caméra</Text>
                📷
            </TouchableOpacity>
            <TouchableOpacity onPress={() => navigation.navigate("Localisation")}> <Text> Géolocalisation</Text>
                📍
            </TouchableOpacity>
